...
# Constants
# ---------------------------------------------------------------------------
SANDBOX_NAMESPACE = "sentinel-sandbox"
SANDBOX_RUNTIME_CLASS = "gvisor"
DEFAULT_IMAGE = "ghcr.io/sentinel-ai/sandbox-runner:latest"
...
def create_sandbox_job(
    ...
    pod_spec = k8s_client.V1PodSpec(
        ...
        service_account_name="sentinel-sandbox-sa",
    ...
    pod_template = k8s_client.V1PodTemplateSpec(
        metadata=k8s_client.V1ObjectMeta(
            labels={
                "app": "sentinel-sandbox",
                "sentinel-ai/job-id": job_id[:63],
            },
            annotations={
